                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input id="nom_product" type="text" class="form-control" name="nom_product" required
                                autofocus>
                        </div>
                        <div class="form-group">
                            <label for=" prix_product">Prix du produit</label>
                            <input id=" prix_product" type="text" class="form-control" name=" prix_product" required
                                autofocus>
                        </div>
                        <div class="form-group">
