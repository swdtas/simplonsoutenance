                ...
                <div class="card-body">
                    <form action="{{ route('product.update', ['id' => $product->id]) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nom_product" name="nom_product"
                                value="{{ old('nom_product', $product->nom_product) }}" required>
                        </div>
                        <div class="form-group">
                            <label for="prix_product">Prix du produit :</label>
                            <input type="text" class="form-control" id="prix_product" name="prix_product"
                                value="{{ old('prix_product', $product->prix_product) }}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary mt-2">Modifier le produit</button>
                    </form>
                </div>
            </div>
        </div>
